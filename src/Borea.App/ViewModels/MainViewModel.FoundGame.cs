...
public partial class MainViewModel
{
    ...
    private async Task OfferFoundGamesAsync(BoreaServices services)
    {
        ...
        if (detection is not { Games.Count: > 0 } || !NeedsGameSetup || _gameTabShown || IsSettingsOpen || IsNameModalOpen || IsDeleteModalOpen || IsReviewingModList || IsLoaderPromptOpen || IsLaunchArgumentsModalOpen || IsLaunchFailureOpen || IsToastDetailsOpen || IsReleaseNotesOpen)
            return;
